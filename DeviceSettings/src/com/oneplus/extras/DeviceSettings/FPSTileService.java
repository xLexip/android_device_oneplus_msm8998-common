...
public class FPSTileService extends TileService {
  ...
  public void onStartListening() {
      ...
      for (ActivityManager.RunningServiceInfo service :
          ...
          if (com.oneplus.extras.DeviceSettings.FPSInfoService.class.getName().equals(
  ...
  @Override
  public void onClick() {
      Intent fpsinfo = new Intent(this, com.oneplus.extras.DeviceSettings.FPSInfoService.class);
      if (!isShowing)
